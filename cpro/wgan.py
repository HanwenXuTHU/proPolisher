...
from cpro.pro_data import LoadData
from torch.utils.data import DataLoader
import torch.autograd as autograd
from cpro.tensor2seq import save_sequence, tensor2seq, reserve_percentage
from cpro.tansfer_fasta import csv2fasta
import cpro.utils as utils
...
def main():
    train_data, test_data = DataLoader(LoadData(is_train=True, split_r=1),
                                       batch_size=32, shuffle=True), DataLoader(LoadData(is_train=True, split_r=1), batch_size=32)
